 ...
 *
 * <p>Tests ensure manifests are validated consistently: chunk offsets,
 * sizes, hashes, required string fields, and internal consistency checks.
 * Both valid and invalid manifest scenarios are covered.
 */
 ...
 *
 * <p>
 * The sealed {@link ValidationResult} type forces exhaustive handling; these
 * tests
 * also verify that callers can use pattern matching on both the {@code Valid}
 * and
 ...
 * Coverage targets:
 * <ul>
 * <li>Valid manifests — single chunk and multi-chunk pass without
 * violations</li>
...
class ManifestValidatorTest {
        ...
        void invalid_summary_containsAllViolationMessages() {
                Manifest manifest = new Manifest("", "", -1L, -1, List.of());
                ValidationResult.Invalid invalid = (ValidationResult.Invalid) ManifestValidator.validate(manifest);
        ...
        @Test
        void validate_manifestFromBuilder_isAlwaysValid(@org.junit.jupiter.api.io.TempDir java.nio.file.Path tempDir)
